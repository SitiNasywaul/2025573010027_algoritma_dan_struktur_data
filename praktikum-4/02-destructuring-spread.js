...
// 1 & 2. Deklarasi array
let timA = ["Budi", "Siti", "Ahmad"];
let timB = ["Rina", "Doni"];

// 3. Gabungkan array dengan spread + tambah anggota baru
let timGabungan = [...timA, ...timB, "Zahra"];

// 4. Destructuring array
let [kapten, ...anggota] = timGabungan;

console.log("Kapten:", kapten);
console.log("Anggota:", anggota);

// 5. Deklarasi object
let pengaturanDefault = {
  tema: "terang",
  bahasa: "id",
  notifikasi: true,
  fontSize: 14
...
// 6. Spread object untuk pengaturan user
let pengaturanUser = {
  ...pengaturanDefault,
  tema: "gelap",
  fontSize: 16
...
let { tema, fontSize } = pengaturanUser;
